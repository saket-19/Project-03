<%@page import="in.co.rays.project_3.controller.ParkingListCtl"%>
<%@page import="in.co.rays.project_3.dto.ParkingDTO"%>
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.PARKING_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.ParkingDTO"
			...
			<center>
				<h1 class="text-light font-weight-bold pt-2">
					<font color="white">Parking List</font>
				</h1>
			</center>
			<center>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<input type="submit" class="btn btn-primary btn-md"
							...
							value="<%=ParkingListCtl.OP_SEARCH%>">&emsp; <input
							type="submit" class="btn btn-dark btn-md" style="font-size: 17px"
							name="operation" value="<%=ParkingListCtl.OP_RESET%>">
					</div>
					...
					<table class="table table-dark table-bordered">
						...
						<tbody>
							<tr>
								...
								<td align="center"><%=dto.getFee()%></td>
								<td align="center"><a href="ParkingCtl?id=<%=dto.getId()%>">Edit</a></td>
							</tr>
						</tbody>
						<%
							}
				...
				<table width="100%">
					<tr>
						...
						<td><input type="submit" name="operation"
							...
							value="<%=ParkingListCtl.OP_NEW%>"></td>
						<td><input type="submit" name="operation"
							class="btn btn-danger btn-md" style="font-size: 17px"
							value="<%=ParkingListCtl.OP_DELETE%>"></td>
				...
				%>
				<center>
					<h1 class="text-primary font-weight-bold pt-3">Parking List</h1>
				</center>
				</br>
				<div class="row">
					<div class="col-md-4"></div>
