...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.PAYMENT_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="text-primary font-weight-bold pt-3"><font color="white">Payment List</h1></font>
			</center>
			</br>
			...
			<div class="row">
						...
						<div class="col-sm-2">
							<input type="text" name="payerName" placeholder="Enter payer Name"
								class="form-control"
								value="<%=ServletUtility.getParameter("payerName", request)%>">
						</div>
						&emsp;
						<div class="col-sm-3">
				...
				<table class="table table-bordered table-dark  table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th class="text">Payer Name</th>
							<th class="text">Payment Id</th>
					...
					<tbody>
						<tr>
							...
							<td align="center"><%=dto.getPayerName()%></td>
							<td align="center"><%=dto.getPaymentId()%></td>
							<td align="center"><%=dto.getPaymentMode()%></td>
							<td align="center"><%=dto.getAmount()%></td>
							<td align="center"><%=dto.getPaymentStatus()%></td>
							<td align="center"><a href="PaymentCtl?id=<%=dto.getId()%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; padding-top: 24px; color: #162390;">Payment
					List</h1>
			</center>
			</br>
			<div class="row">
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=PaymentListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
