...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.VOICE_COMMAND_LIST_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.VoiceCommandDTO"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="commandCode" placeholder="Command Code"
						class="form-control"
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=VoiceCommandListCtl.OP_SEARCH%>">&emsp;
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Command Code</th>
							<th width="20%" class="text">User Name</th>
							<th width="25%" class="text">Command Text</th>
					...
					<tbody>
						<tr>
							...
							<td class="text">
								<a href="VoiceCommandCtl?id=<%=dto.getId()%>">Edit</a>
							</td>
						</tr>
					</tbody>
					<%
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=VoiceCommandListCtl.OP_PREVIOUS%>" <%=pageNo > 1 ? "" : "disabled"%>></td>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;"
						value="<%=VoiceCommandListCtl.OP_NEXT%>" <%=(nextPageSize != 0) ? "" : "disabled"%>></td>
				</tr>
				<tr></tr>
			</table>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">VoiceCommand List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
