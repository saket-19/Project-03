		...
		<form action="<%=ORSView.PROFILE_LIST_CTL%>" method="post">
			...
			<center>
				...
				<center>
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<input type="submit" class="btn btn-primary btn-md"
								...
								value="<%=ProfileListCtl.OP_SEARCH%>">&emsp; <input
					...
					<table width="100%">
						<tr>
							...
							<td align="right"><input type="submit" name="operation"
								class="btn btn-secondary btn-md" style="font-size: 17px"
								style="padding: 5px;" value="<%=ProfileListCtl.OP_NEXT%>"
					...
					%>
					<center>
						<h1 class="text-primary font-weight-bold pt-3">Profile List</h1>
					</center>
