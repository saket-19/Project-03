        ...
        <form action="<%=ORSView.ASSET_LIST_CTL%>" method="post">
            ...
            <center>
                <h1 class="text-light font-weight-bold pt-2">
                    <font color="white">Asset List</font>
                </h1>
            </center>
            <center>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="assetCode" placeholder="Enter Asset Code"
                            class="form-control"
                            value="<%=ServletUtility.getParameter("assetCode", request)%>">
                    </div>
                    &emsp;
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <input type="submit" class="btn btn-primary btn-md"
                            ...
                            value="<%=AssetListCtl.OP_SEARCH%>">&emsp;
                    ...
                    <table class="table table-dark table-bordered">
                        <thead>
                            <tr style="background-color: #8C8C8C;">
                                ...
                                <th class="text">Asset Code</th>
                                <th class="text">Asset Name</th>
                                <th class="text">Asset Type</th>
                                <th class="text">Asset Status</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center"><%=dto.getAssetCode()%></td>
                                <td align="center"><%=dto.getAssetName()%></td>
                                <td align="center"><%=dto.getAssetType()%></td>
                                <td align="center"><%=dto.getAssetStatus()%></td>
                                <td align="center"><a href="AssetCtl?id=<%=dto.getId()%>">Edit</a></td>
                            </tr>
                        </tbody>
                        <%
                            }
            ...
            %>
                <center>
                    <h1 class="text-primary font-weight-bold pt-3">Asset List</h1>
                </center>
                </br>
                <div class="row">
                    <div class="col-md-4"></div>
