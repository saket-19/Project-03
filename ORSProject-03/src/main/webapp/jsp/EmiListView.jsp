<%@page import="in.co.rays.project_3.controller.EmiListCtl"%>
<%@page import="in.co.rays.project_3.dto.EmiDTO"%>
    ...
    <div>
        <form action="<%=ORSView.EMI_LIST_CTL%>" method="post">
            ...
            <%
                ...
                Iterator<EmiDTO> it = list.iterator();
                if (list.size() != 0) {
            %>
            <center>
                <h1 class="text-light font-weight-bold pt-2">
                    <font color="white">EMI List</font>
                </h1>
            </center>
            <center>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="emiCode" placeholder="Enter EMI Code"
                            class="form-control"
                            value="<%=ServletUtility.getParameter("emiCode", request)%>">
                    </div>
                    &emsp;
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <input type="submit" class="btn btn-primary btn-md"
                            ...
                            value="<%=EmiListCtl.OP_SEARCH%>">&emsp;
                        <input type="submit" class="btn btn-dark btn-md"
                            style="font-size: 17px" name="operation"
                            value="<%=EmiListCtl.OP_RESET%>">
                    </div>
                    <div class="col-sm-2"></div>
                </div>
                    ...
                    <table class="table table-dark table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center"><%=dto.getEmiCode()%></td>
                                ...
                                <td align="center"><a href="EmiCtl?id=<%=dto.getId()%>">Edit</a></td>
                            </tr>
                        </tbody>
                        <%
                            }
                ...
                <table width="100%">
                    <tr>
                        <td><input type="submit" name="operation"
                            ...
                            value="<%=EmiListCtl.OP_PREVIOUS%>"
                            <%=pageNo > 1 ? "" : "disabled"%>></td>
                        <td><input type="submit" name="operation"
                            class="btn btn-primary btn-md" style="font-size: 17px"
                            value="<%=EmiListCtl.OP_NEW%>"></td>
                        <td><input type="submit" name="operation"
                            class="btn btn-danger btn-md" style="font-size: 17px"
                            value="<%=EmiListCtl.OP_DELETE%>"></td>
                        <td align="right"><input type="submit" name="operation"
                            class="btn btn-secondary btn-md" style="font-size: 17px"
                            value="<%=EmiListCtl.OP_NEXT%>"
            ...
            %>
                <center>
                    <h1 class="text-primary font-weight-bold pt-3">EMI List</h1>
                </center>
                </br>
                <div class="row">
                    <div class="col-md-4"></div>
