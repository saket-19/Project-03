...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.BATCH_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=BatchListCtl.OP_SEARCH%>">&emsp;
					<input type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=BatchListCtl.OP_RESET%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Batch Code</th>
							<th width="25%" class="text">Batch Name</th>
							<th width="15%" class="text">Total Records</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getBatchCode()%></td>
							<td class="text"><%=dto.getBatchName()%></td>
							<td class="text"><%=dto.getTotalRecords()%></td>
							<td class="text"><%=dto.getStatus()%></td>
							<td class="text">
								<a href="BatchCtl?id=<%=dto.getId()%>">Edit</a>
							</td>
						</tr>
					</tbody>
					<%
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=BatchListCtl.OP_PREVIOUS%>" <%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=BatchListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=BatchListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;"
						value="<%=BatchListCtl.OP_NEXT%>" <%=(nextPageSize != 0) ? "" : "disabled"%>></td>
				</tr>
				<tr></tr>
			</table>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Batch List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=BatchListCtl.OP_BACK%>">
			</div>
