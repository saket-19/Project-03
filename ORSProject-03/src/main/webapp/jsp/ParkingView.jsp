<%@page import="in.co.rays.project_3.controller.ParkingCtl"%>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            %>
                            <h3 class="text-center text-primary">Update Parking</h3>
                            <%
                                } else {
                            %>
                            <h3 class="text-center text-primary">Add Parking</h3>
                            <%
                                }
                            %>
                            ...
                            <div class="md-form">
                                ...
                                <!-- Capacity -->
                                <span class="pl-sm-5"><b>Capacity</b><span style="color: red;">*</span></span></br>
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                ...
                                <!-- Fee -->
                                <span class="pl-sm-5"><b>Fee</b><span style="color: red;">*</span></span></br>
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="fee"
                                            ...
                                            value="<%=DataUtility.getStringData(dto.getFee())%>">
                                    </div>
                                </div>
                                <font color="red" class="pl-sm-5"><%=ServletUtility.getErrorMessage("fee", request)%></font></br>

                                <% if (id > 0) { %>
                                <div class="text-center">
                                    <input type="submit" name="operation"
                                        class="btn btn-success btn-md" style="font-size: 17px"
                                        value="<%=ParkingCtl.OP_UPDATE%>">
                                    <input type="submit" name="operation"
