...
<body class="p4">
	...
	<div>
		...
		<form action="<%=ORSView.PAYMENT_CTL%>" method="post">
			<%
				HashMap payMode = (HashMap) request.getAttribute("payyMode");
				HashMap payStatus = (HashMap) request.getAttribute("payyStatus");
			%>
				...
				<div class="col-md-4 mb-4 ">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Payer Name</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
												<i class="fas fa-desktop" style="font-size: 1rem;"></i>
											</div>
										</div>
										<input type="text" class="form-control" name="payerName"
											placeholder="enter Name"
											value="<%=DataUtility.getStringData(dto.getPayerName())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("payerName", request)%></font></br>

								<span class="pl-sm-5"><b>Payment Id</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="paymentId"
											placeholder="enter Name"
											value="<%=DataUtility.getStringData(dto.getPaymentId())%>"
>
									</div>
								</div>

								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("paymentId", request)%></font></br>

								<span class="pl-sm-5"><b>Payment Mode</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<%=HTMLUtility.getList("paymentMode", dto.getPaymentMode(), payMode)%>
									</div>
								</div>
								...
								<span class="pl-sm-5"><b>Payment Status</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<%=HTMLUtility.getList("paymentStatus", dto.getPaymentStatus(), payStatus)%>
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("payStatus", request)%></font></br>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=PaymentCtl.OP_SAVE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
