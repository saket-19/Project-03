...
/**
 * Batch List functionality controller.to perform Search and List operation.
 * 
 * @author saket
 *
 */
...
public class BatchListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("BatchListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			dto = (BatchDTO) populateDTO(request);
		...
		log.debug("BatchListCtl doPost End");
	}
