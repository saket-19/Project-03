...
/**
 * LanguageTranslation List functionality controller.to perform Search and List operation.
 * 
 * @author saket
 *
 */
...
public class LanguageTranslationListCtl extends BaseCtl {
	...
	private static Logger log = Logger.getLogger(LanguageTranslationListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("LanguageTranslationListCtl doGet Start");
		List list;
		List next;
		int pageNo = 1;
		...
		log.debug("LanguageTranslationListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.debug("LanguageTranslationListCtl doPost Start");
		List list = null;
		List next = null;
		...
		try {
			...
			dto = (LanguageTranslationDTO) populateDTO(request);
		...
		log.debug("LanguageTranslationListCtl doPost End");
	}

	@Override
	protected String getView() {
		return ORSView.LANGUAGE_TRANSLATION_LIST_VIEW;
	}
}